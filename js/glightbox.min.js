!function(e, t) {
    ...
    function R(e, t, i) {
        ...
        o.insertBefore(x('<div class="gvideo-wrapper"></div>'), o.firstChild);
        ...
        T(this.settings.plyr.js, "Plyr", (function() {
            ...
            if (null !== h.match(/\.(mp4|ogg|webm|mov)$/)) {
                ...
                for (var p in f[c = "mov" == c ? "mp4" : c] = h,
                f)
    ...
    function Z(e, t, i) {
        var n, s = this, l = e.querySelector(".gslide-media"), o = !(!M(t, "href") || !t.href) && t.href.split("#").pop().trim(), r = !(!M(t, "content") || !t.content) && t.content;
        if (r && (E(r) && (n = x('<div class="ginlined-content">'.concat(r, "</div>"))),
        A(r))) {
      ...
      , J = function() {
        ...
        return n(e, [{
            ...
            value: function() {
                ...
                "video" !== o) {
                    if ("external" !== o)
                        return "inline" === o ? (Z.apply(this.instance, [t, s, v]),
      ...
      , ie = function() {
        ...
        return n(e, [{
            ...
            value: function() {
                ...
                this.showSlide(i, !0),
                1 == this.elements.length ? (y(this.prevButton),
                y(this.nextButton)) : (m(this.prevButton),
                m(this.nextButton)),
                this.lightboxOpen = !0,
                this.trigger("open"),
